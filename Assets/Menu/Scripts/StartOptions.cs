...
public class StartOptions : MonoBehaviour {
	...
	public int instScene = 15;
	public int credScene = 16;										//Index number in build settings of scene to load if changeScenes is true
	...
	public void CredButtonClicked()
	{

		//Use invoke to delay calling of LoadDelayed by half the length of fadeColorAnimationClip
		Invoke ("LoadDelayedCred", fadeColorAnimationClip.length * .5f);
